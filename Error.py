#!/usr/bin/python2
#coding=utf-8
#This Script Is Written By BLACKTIGER
  #================《welcome》=================#
  #BlackTiger-Error404 The Official Programmrer#   
...
\033[1;95m╔═━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⌗⊰
\033[1;92m║\033[1;93mAUTHOR ⊱⟡⊰ \033[1;92m《♡BlackTiger♡》   
\033[1;92m║\033[1;93mCREATE BY ⊱  \033[1;92m《♡BlackTiger-Error404♡》
\033[1;92m║\033[1;93mWHATSAPP ⊱⟡⊰ \033[1;92m《♡+923037335114♡》          
\033[1;95m╚═━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⌗⊰                        
...
\033[1;93m 《♡WHATSAPP♡☆+923037335114☆》 ✔️
\033[0;33m⚚═╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌═⚚

\033[0;33m⚚═╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌═⚚
\033[0;92m《Use the ☆USA☆Proxy》Super VPN
...
jalan('\033[1;31m BlackTiger-Error404 ⋕⋕') 
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "\033[1;32mLOADING..... " + username #Dev:BLACKTIGER-ERROR404
	    time.sleep(2)
            loop = 'false'
        else:
...
def menu():
	...
	print "\033[1;93mBLACK_TIGER HACKER ™"
...
"""
	...
	p.map(main, id)
	print "\033[0;33m⚚═╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌═⚚"
	print "  \033[1;93m⚚═╌╌╌ Developed By BlackTiger-Error404╌╌╌═⚚" #Dev:BLACKTIGER
	...
	print """
\033[0;94mThanks for using my tool 
To learn cloning 《Whatsapp +923037335114》
 """
